...
const cyhal_resource_inst_t CLK_I2CM_obj =
{
    .type = CYHAL_RSC_CLOCK,
    .block_num = CLK_I2CM_HW,
    .channel_num = CLK_I2CM_NUM,
};
...
void init_cycfg_clocks(void)
{
    ...
    Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_8_BIT, 4U, 23U);
    Cy_SysClk_PeriphEnableDivider(CY_SYSCLK_DIV_8_BIT, 4U);
    Cy_SysClk_PeriphDisableDivider(CY_SYSCLK_DIV_16_BIT, 0U);
    Cy_SysClk_PeriphSetDivider(CY_SYSCLK_DIV_16_BIT, 0U, 2399U);
...
void reserve_cycfg_clocks(void)
{
    ...
    cyhal_hwmgr_reserve(&CLK_I2CM_obj);
