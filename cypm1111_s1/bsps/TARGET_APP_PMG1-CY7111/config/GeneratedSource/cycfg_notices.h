...
#if !defined(CYPM1111_40LQXIT)
#error "Unexpected MPN; expected DEVICE:=CYPM1111-40LQXIT. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYPM1111_40LQXIT) */
